            ...
            {user_id ? (
               <div className="flex flex-col gap-5">
                  <div className="flex justify-between">
                     ...
                     { fullUserData.approved && <button onClick={setRetailerModal} className="bg-cyan-500 text-white px-4 py-2 rounded font-semibold">Add Retailer</button> }
                  </div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-5">
                     <div className="flex flex-col gap-1 bg-white bg-opacity-20 p-4 rounded-md shadow">
                        ...
                        <p className="text-md font-medium flex gap-3 items-center justify-between"><span>{companyName}</span> {fullUserData.approved ? <span className="bg-green-500 text-white px-1 rounded text-[10px]">Approved!</span> : <span className="bg-red-500 text-white px-1 rounded text-[10px]">Not Approved!</span>}</p>
                     </div>
                     <div className="flex flex-col gap-1 bg-white bg-opacity-20 p-4 rounded-md shadow">
                  ...
                  {user_metadata.role === "Aggregator" ? (
                     ...
                     <div>
                        ...
                        {user_metadata.role === "Distributor" && fullUserData.approved === false && requestApproval === false ? (
                           <div>
                              <div className="bg-white bg-opacity-15 p-4 rounded-md shadow flex gap-4 items-center justify-between">
                                 <h2 className="text-lg font-semibold">
                                    Not Approved yet! Click the button to request for approval
                                 </h2>
                                 <button
                           ...
                           <div>
                              {user_metadata.role === "Distributor" && fullUserData.approved === false && requestApproval === true && (
                                 <div>
                                 <div className="bg-white bg-opacity-15 p-4 rounded-md shadow flex gap-4 items-center justify-between">
                                    <h2 className="text-lg font-semibold">
